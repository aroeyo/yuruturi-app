...
<div class="about-site">
    ...
    <div class="about">
        <a href=""><img src="{{asset('images/aboutimage2.webp')}}" alt="About Image 2" width="250px" height="auto"></a>
        <h3>釣果記録</h3>
        <p>あなたの釣果を簡単に記録し、写真と一緒に保存。釣った魚、場所、時間を後からいつでも振り返ることができます。</p>
    </div>
    <div class="about">
        <a href=""><img src="{{asset('images/aboutimage3.webp')}}" alt="About Image 3" width="250px" height="auto"></a>
        <h3>ランキング</h3>
